...
class ImageController extends Controller
{
    public function categoryAction($id)
    {
        ...
        $category = $em->getRepository('COCBundle:CategoryImage')->findById($id);
        $list = $em->getRepository('COCBundle:Image')->getImagesByCategory($id);


        return $this->render('COCBundle:Image:category.html.twig', array('images' => $list, 'category' => $category ));
    }
